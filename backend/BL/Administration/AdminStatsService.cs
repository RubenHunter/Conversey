...
public class AdminStatsService : IAdminStatsService
{
    ...
    private List<ActionWidgetDto> GetPlatformActionWidgets()
    {
        ...
        {
            new() { Title = "Create New", Description = "Add a new workspace to your platform", Icon = "<svg fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M12 4.5v15m7.5-7.5h-15'/></svg>", ActionText = "New Workspace", ActionUrl = "/admin/workspaces/create", IsModal = false }
        };
    }
    ...
    private QuickLinksWidgetDto GetPlatformQuickLinksWidget()
    {
        return new QuickLinksWidgetDto
        {
            ...
            {
                new() { Title = "New workspace", Description = "Create a new workspace", Icon = "<svg fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M12 4.5v15m7.5-7.5h-15'/></svg>", IconBackground = "bg-yellow-100", IconColor = "text-yellow-500", ModalTarget = "modal-new-workspace", NavigateUrl = "/admin/workspaces/create" },
                new() { Title = "Check health", Description = "Check AI provider", Icon = "<svg fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z'/></svg>", IconBackground = "bg-pink-100", IconColor = "text-pink-400", NavigateUrl = "/admin/ai/health" },
                new() { Title = "Rate Limits", Description = "Limits for AI endpoints", Icon = "<svg fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-9.75 0h9.75'/></svg>", IconBackground = "bg-pink-100", IconColor = "text-pink-400", NavigateUrl = "/admin/ai/rate-limits" }
            }
        };
    }
    ...
    private List<ActionWidgetDto> GetWorkspaceActionWidgets(Slug workspaceId)
    {
        return new List<ActionWidgetDto>
        {
            new() { Title = "Create New", Description = "Add a new project to your workspace", Icon = "<svg fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M12 4.5v15m7.5-7.5h-15'/></svg>", ActionText = "New Project", ActionUrl = "/admin/projects/create", IsModal = false }
        };
    }
    ...
    private QuickLinksWidgetDto GetWorkspaceQuickLinksWidget()
    {
        return new QuickLinksWidgetDto
        {
            ...
            Items = new List<QuickLinkItemDto>
            {
                new() { Title = "New project", Description = "Create a new project", Icon = "<svg fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M12 4.5v15m7.5-7.5h-15'/></svg>", IconBackground = "bg-yellow-100", IconColor = "text-yellow-500", ModalTarget = "modal-new-project", NavigateUrl = "/admin/projects/create" },
                new() { Title = "AI Settings", Description = "Configure AI for workspace", Icon = "<svg fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z'/></svg>", IconBackground = "bg-primary/10", IconColor = "text-primary", NavigateUrl = "/admin/{workspaceSlug}/ai" }
            }
        };
    }
