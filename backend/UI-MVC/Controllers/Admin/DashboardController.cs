    ...
    public async Task<IActionResult> Index()
    {
        if (_adminContext.CurrentAdmin.IsConverseyAdmin())
        {
            ...
            viewModel.NavCards = new List<NavCardViewModel>
            {
                ...
                new() { Title = "AI Configuration", Description = "Configure AI providers and settings", Icon = "<svg class='w-5 h-5' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z'/></svg>", NavigateUrl = "/admin/ai", IconBackground = "bg-blue-100" }
            };
        ...
        else if (_adminContext.CurrentAdmin.IsWorkspaceAdmin())
        {
            ...
            viewModel.NavCards = new List<NavCardViewModel>
            {
                new() { Title = "Manage Projects", Description = "Create and manage projects in this workspace", Icon = "<svg class='w-5 h-5' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12'/></svg>", NavigateUrl = "/admin/projects", IconBackground = "bg-orange-100" },
                new() { Title = "AI Settings", Description = "Configure AI for this workspace", Icon = "<svg class='w-5 h-5' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z'/></svg>", NavigateUrl = $"/admin/{workspaceId}/ai", IconBackground = "bg-green-100" }
            };
